...
| `dot` | Visual reroute point (ctrl+click an edge to insert). Resolves straight through in `getConnectedInputs` — never mirrors the image into its own data | image | image |
