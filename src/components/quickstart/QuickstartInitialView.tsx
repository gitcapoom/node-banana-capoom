      ...
      <div className="flex gap-10">
        ...
        <div className="flex-1 flex flex-col">
          ...
          <p className="text-sm text-neutral-400 leading-relaxed mb-6">
            A node based workflow editor for AI generation of all sorts. Connect nodes to build pipelines that transform and generate images, videos, audio and 3D. Forked from great work done by William Falloon&apos;s <a href="https://github.com/shrimbly/node-banana" target="_blank" rel="noopener noreferrer" className="text-neutral-300 hover:text-neutral-100 underline transition-colors">&quot;Node Banana&quot;</a>
          </p>
