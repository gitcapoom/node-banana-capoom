...
const IMAGE_SOURCE_OPTIONS: MenuOption[] = [
  ...
  {
    type: "sphereLightRender",
    label: "Sphere Light Render",
    icon: (
      <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
const VIDEO_TARGET_OPTIONS: MenuOption[] = [
  ...
  },
  {
    ...
    icon: (
      <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 3.75H6A2.25 2.25 0 003.75 6v1.5M16.5 3.75H18A2.25 2.25 0 0120.25 6v1.5m0 9V18A2.25 2.25 0 0118 20.25h-1.5m-9 0H6A2.25 2.25 0 013.75 18v-1.5M12 3.75v16.5" />
      </svg>
    ),
  },
  {
